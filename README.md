...
- **Nothing happens to your schema implicitly.** There is no `AUTO MIGRATE` and
  ...
  declarations owned it, [managed mode](docs/migrations.md) writes migration
...
The whole thing is documented in **[docs/migrations.md](docs/migrations.md)**,
...
discipline. [docs/production.md](docs/production.md) is the guide they belong to.
