...
Возврат nil коммитит. Возврат ошибки откатывает. Паника откатывает и паникует дальше. **Ничего не повторяется** — политика повторов зависит от того, чем была работа, а библиотека этого не знает.
