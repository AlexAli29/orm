...
Скобки — это грамматика, а не стиль. Без них PostgreSQL относит эти клаузы ко всему составному запросу, и ветвь, которая выглядит ограниченной, таковой не является. Компилятор ставит скобки ровно тогда, когда ветвь несёт что-то из этого.

## Клаузы составного запроса
